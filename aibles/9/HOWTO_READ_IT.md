...
A practical note: the automatic summarisers do not help here. Adobe's fails on a document this size. The book is longer than the tools built to compress books can handle.
